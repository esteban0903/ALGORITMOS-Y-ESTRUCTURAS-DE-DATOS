...
def main():
    # ubicaciones
    ubicaciones = set([1, 2, 3, 4, 5, 6, 7, 8])
    conexiones = set([(1, 2), (1, 3), (2, 3), (2, 4), (3, 5), (4, 6), (5, 6), (5, 7), (6, 8)])
    graph = Graph(ubicaciones, conexiones, True, False)
    printAdjList(graph)
    ...
    ubicacion_inicial=1
    ubicacion_final=8
    bfs_r=graph.bfs(ubicacion_inicial)
    # print("BFS {}".format(ubicacion_final))
    # printVProps(bfs_r)
    camino = getPath(ubicacion_final, bfs_r)
    print("Camino sugerido de {} hacia {}".format(ubicacion_inicial, ubicacion_final),camino)
