...
class LinkedList:
    ...
    def delete(self, value):
        ...
        if value_node is not None:
            ...
            while current_node.getNext() is not None and (current_node.getNext().getValue() != value):
                current_node = current_node.getNext()
            # ELEMENTO
            if current_node.getNext() is not None:
...
def main():
    lista=[2]
    lista1=LinkedList(lista)
    print(lista1)
    lista1.delete(2)
    print(lista1)
    print("head",lista1.getHead())
    print("tail",lista1.getTail())
